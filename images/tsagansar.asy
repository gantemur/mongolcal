...
draw(graph(year,dd,c),rgb(1,.3,.3),marker=marker(scale(circlescale)*unitcircle,rgb(.5,.5,.5),Fill));
xlimits(ymin-5,ymax+5);
ylimits(25,60);
xaxis(BottomTop,Ticks(Step=50, step=10,pTick=lightgrey, ptick=lightgrey,extend=true));
