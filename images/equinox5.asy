...
ylimits(-24*11,65);
xaxis(BottomTop,Ticks(Step=1000, step=200,pTick=lightgrey, ptick=lightgrey,extend=true));
yaxis(LeftRight,RightTicks(Step=48,step=12,pTick=lightgrey, ptick=lightgrey,extend=true,ticklabel=gg));
