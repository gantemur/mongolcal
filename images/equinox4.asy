...
ylimits(-80,48);
xaxis(BottomTop,Ticks(Step=1000, step=100,pTick=lightgrey, ptick=lightgrey,extend=true));
yaxis(LeftRight,RightTicks(Step=24,step=6,pTick=lightgrey, ptick=lightgrey,extend=true,ticklabel=gg));
